...
from typing import (TYPE_CHECKING, AbstractSet, Any, Callable, Dict, Generator,
                    Iterable, Iterator, List, Mapping, Optional, Set, Tuple,
                    Type, TypeVar, Union, no_type_check)
...
if TYPE_CHECKING:
    ...
    from .typing import (AbstractSetIntStr, DictIntStrAny,  # noqa: F401
                         IntStr, MappingIntStrAny, ReprArgs)
